...
namespace Drupal\step\Plugin\CKEditorPlugin;
...
class StepPlugin extends PluginBase implements CKEditorPluginInterface, CKEditorPluginButtonsInterface {
  ...
  public function getButtons() {
    return [
      'step' => [
        'label' => $this->t('Add Step'),
        'image' => drupal_get_path('module', 'step') . '/js/plugins/step/icons/step.png',
      ],
    ];
  }
  ...
  public function getFile() {
    return drupal_get_path('module', 'step') . '/js/plugins/step/plugin.js';
  }
